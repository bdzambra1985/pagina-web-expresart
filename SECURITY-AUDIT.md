...
## Ronda 2 — 2026-07-17 · auditoría profunda (SRI, service worker, autorización)
...
| 2 | Alta | Hash de contraseñas con salt global único, sin salt por usuario (`utils/crypto.js`). | **Corregido** — PBKDF2 con salt aleatorio por usuario. *(Superado en la ronda 3: ahora scrypt.)* |
